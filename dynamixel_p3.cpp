...
unsigned int DynamixelClass::enableTorque(unsigned char ID, bool value) {
	Instruction_Packet_Array[0] = ID;
	Instruction_Packet_Array[1] = 0x04;
	Instruction_Packet_Array[2] = 0x03;
	Instruction_Packet_Array[3] = 0x46;
